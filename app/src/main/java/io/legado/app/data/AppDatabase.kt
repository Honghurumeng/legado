...
import io.legado.app.data.dao.AiChapterCommentDao
...
@Database(
    version = 76,
    exportSchema = true,
    entities = [AiChapterComment::class, Book::class, BookGroup::class, BookSource::class, BookChapter::class,
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val aiChapterCommentDao: AiChapterCommentDao
